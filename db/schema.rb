...
ActiveRecord::Schema.define(version: 2020_11_12_123559) do
  ...
  create_table "shoppingcart_items", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["item_id"], name: "index_shoppingcart_items_on_item_id"
  ...
  add_foreign_key "shoppingcart_items", "items"
